...
[Serializable]
public class Chest_S : MonoBehaviour, IUsable
{
    ...
    private ItemSlotScript[] slots = new ItemSlotScript[8];
    ...
    private void Awake()
    {
        ...
        Transform tmpElemList = GameObject.FindWithTag("MainMenu").transform.Find("Chest_S").GetChild(0);
    ...
    public void Initialize()
    {
        ...
        InGameMenu.Instance.OnSimpleMenuOpen(3, true);
